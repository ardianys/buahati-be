                    ...
                    <section>
                        <header>
                            ...
                            <div class="flex justify-end mt-5">
                                <a href="{{ route('attendances.create') }}" class="px-2 py-1 rounded-md bg-sky-500 text-white hover:bg-sky-600" title="Add New Attendance">Add New</a>
                            </div>
                        </header>
                        </br>
                            ...
                            @foreach($attendances as $item)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <form method="POST" action="{{ route('attendances.destroy', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            @csrf()
                                            <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded" title="Delete Attendance" onclick="return confirm(&quot;Confirm delete?&quot;)">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
